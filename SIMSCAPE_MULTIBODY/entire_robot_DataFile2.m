...
smiData.RigidTransform(1).translation = [-1180.3064414824889 1016.7457521207604 1121.21195539626];  % mm
smiData.RigidTransform(1).angle = 4.5854299439284996e-16;  % rad
smiData.RigidTransform(1).axis = [0.40924388237009718 -0.91242503513584605 -8.5610977536793677e-17];
smiData.RigidTransform(1).ID = "B[top-1:-:BaseR-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-1180.3064413748873 1016.7457521888221 1121.2119553962225];  % mm
smiData.RigidTransform(2).angle = 2.4825341532472736e-16;  % rad
smiData.RigidTransform(2).axis = [-0.99130540629684682 -0.13158112116349968 1.619072489730507e-17];
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [457.25981117489533 -979.69195539621342 1616.3313119052461];  % mm
smiData.RigidTransform(5).angle = 1.6664335535985504;  % rad
smiData.RigidTransform(5).axis = [-0.9086608545660243 -0.29524180884432899 -0.29524180884432899];
smiData.RigidTransform(5).ID = "RootGround[BaseR-1]";
...
smiData.RevoluteJoint(1).Rz.Pos = 38.008164717474443;  % deg
